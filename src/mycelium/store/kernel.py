...
-- parent_id. Deleting the owning statement link cascades to its tree.
-- ON DELETE RESTRICT on statement_id requires writers to rewrite or remove
-- conditions before deleting the statements they reference.
